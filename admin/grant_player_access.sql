...
BEGIN
    ...
    EXECUTE IMMEDIATE 'GRANT EXECUTE ON durak_console TO ' || v_username;
    ...
    FOR r IN (
        ...
        FROM (
            ...
            UNION ALL SELECT 'V_GAME_CONSOLE' FROM dual
            UNION ALL SELECT 'V_LOG_TEXT' FROM dual
        )
    ) LOOP
        EXECUTE IMMEDIATE
    ...
    DBMS_OUTPUT.PUT_LINE(
        'Доступ к DURAK_API, DURAK_CONSOLE и защищённым представлениям выдан пользователю '
        || v_username || '.'
    );
END;
/
